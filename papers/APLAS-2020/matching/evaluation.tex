\newcommand{\mywrap}[1]{\centering{\textbf{#1}}}
\newcommand{\myhack}[2]{
  \multicolumn{1}{m{#1}|}{
    \rotatebox{90}{\parbox[2cm]{1.5cm}{\mywrap {#2}}}
  }
...
%  \parbox[b][.5cm]{3cm}{\textbf{Patterns}} & 
  ...
  \myhack{1.1cm}{1st answer size } &
  \myhack{1.2cm}{1st answer time(ms)} &
  \myhack{.7cm}{Answers found} &
  \myhack{1.2cm}{Optimal answer size} &
  \myhack{1.1cm}{Optimal answer time(ms)} &
  \myhack{1.5cm}{Total search time (ms)} 
    \\ \hline
