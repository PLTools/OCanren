...
The 4th benchmark was taken from~\cite{maranget2008}, we used it in %Section~\ref{sec:intro} (
...
machine for PCF~\cite{maranget2008,Plotkin1977LCFCA}. For such complex examples (in terms of type definition complexity and number and size of patterns)
