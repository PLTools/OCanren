...
%\textcolor{blue}{
%  We studied the scheduling complexity of interleaving search in the context of \mK relational programming language. In a broader context
%  of conventional logical programming interleaving search is rarely used due to its poor compatibility with conventional extra-logical
%  features such as ``cut''; nevertheless in 
%}
