...
run 1 (fun q -> append$^o$ [1;2] [3] q)
            $\leadsto$ {q=[1;2;3]}

run 3 (fun q r -> append$^o$ q r [1;2])
            $\leadsto$ {q=[ ], r=[1;2];
            ~\phantom{$\leadsto$}~  q=[1], r=[2];
            ~\phantom{$\leadsto$}~  q=[1;2], r=[ ]}
\end{filecontents*}
    ...
    \begin{block}{Approach}
      ...
      \begin{figure}
        ...
        \begin{tikzpicture}%[scale=1.2]
          ...
          \draw [->, line width=13, blue] (-2.5,1) .. controls (-1,3.5) and (1,3.5) .. (2.5,1);
