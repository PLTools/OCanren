...
%% \begin{filecontents*}{verify.ml}
%%    let verify$^o$ assert$^o$ t = run * (fun t'. 
%%      consistent$^o$ !assert$^o$ t t'
%%    )
%% \end{filecontents*}

% \begin{filecontents*}{verify.ml}
%    let verify t assert$^o$ =
%      run * fun t'. (eval$^o$ t t') /\ (!assert$^o$ t')
% \end{filecontents*}

% \begin{filecontents*}{solve.ml}
%    let solve n sketch$^o$ assert$^o$ = 
%      run n fun t. 
%        (sketch$^o$ t) /\ 
%        (fresh (t') 
%          (eval$^o$ t t') /\ 
...
% \begin{filecontents*}{synth.ml}
%    let synth n sketch$^o$ assert$^o$ = 
%      run n fun t. 
%        (sketch$^o$ t) /\ 
%       !(fresh (t') 
%          (eval$^o$ t t') /\ 
...
% \begin{filecontents*}{mp_init.c11}
%    $[$x$]_{na}$ = 0; $[$f$]_{na}$ = 0
% \end{filecontents*}

% \begin{filecontents*}{mp_bad_thrd1.c11}
%    $[$x$]_{na}$ := 42;
%    $[$f$]_{na}$ := 1
% \end{filecontents*}

% \begin{filecontents*}{mp_bad_thrd2.c11}
%    repeat $[$f$]_{na}$;
%    $r1$ = $[$x$]_{na}$
% \end{filecontents*}

% \begin{filecontents*}{mp_part_thrd1.c11}
%    $[$x$]_{na}$ := 42;
%    A
% \end{filecontents*}

% \begin{filecontents*}{mp_part_thrd2.c11}
%    B
%    $r1$ = $[$x$]_{na}$
% \end{filecontents*}

% \begin{filecontents*}{mp_sketch.ml}
%   let scketch_mp$^o$ t = 
%     fresh (A B)
%       (stmt$^o$ A) /\ (stmt$^o$ B) /\ (t === sketch_MP)
% \end{filecontents*}

% \begin{filecontents*}{verify_mp.ml}
%    > verify prog_mp (fun p'. p'{r1 === 42}) 
%    [p'=stuck]
% \end{filecontents*}

% \begin{filecontents*}{solve_mp.ml}
%    > solve 1 scketch_mp (fun p'. p'{r1 === 42})
%    [A=$[$f$]_{rel}$ := 1; B=repeat $[$f$]_{acq}$;]
% \end{filecontents*}

% \begin{filecontents*}{synth_mp.ml}
%    > synth 1 sketch_mp (fun p'. p'{r1 === 42})
%    [A=$[$f$]_{rel}$ := 1; B=repeat $[$f$]_{acq}$;]
% \end{filecontents*}
