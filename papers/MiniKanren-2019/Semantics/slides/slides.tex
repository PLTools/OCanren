...
It is rather long and it is green!
...
Formalization revealed serious flaws in proofs for both directions

We fixed them, now we can be sure everything is OK
...
Transformations, that do not change mathematical relation,\\do not change the result of its execution (the set of answers):
...
Programs can be reduced to a normal form
...
Some other proven (not certified) facts:

\vskip4mm

\begin{itemize}

\item Correctness of a certain optimization \textcolor{red}{?}

\vskip6mm

\item Refutational incompleteness of \lstinline|append$^o$|

\vskip6mm

\item Linear refutational completeness of \lstinline|append$^o$|
...
\begin{frame}{What else should we prove?}

\begin{itemize}

\item Language extensions (the first thing --- disequality constraints)
...
\item Your suggestions are very welcome!
