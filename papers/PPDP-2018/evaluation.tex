...
cases and slow down the optimistic, thus we've ran the improved search in all cases and compared the running time
...
order of conjuncts. With the exception of a very small input sizes, the improved search provided a speedup up to
