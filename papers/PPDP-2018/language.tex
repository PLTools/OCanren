...
We illustrate the evaluation, determined by this semantics, by a canonical example for relational programming~--- list concatenation relation \lstinline|append$^o$| 
