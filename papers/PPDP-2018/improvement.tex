...
since $g_2$ converges on $\sigma$, it will converge on each \mbox{$\sigma^\prime\in S^\prime_\omega$} as well.
...
steps coinside with those, according to ``$\xRightarrow{}$''. Thus, the imroved search is non-degrading.
