...
\begin{definition}
A triplet of interpretetion, substitution and a set of allocated semantic variables \mbox{$(\iota,\sigma,\delta)$} is
...
Suppose none of $g_i$ converges on $S_\omega$ (i.e. there is at least one substitution in $S_\omega$, on which
