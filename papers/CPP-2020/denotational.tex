...
for disjunction and conjunction of goals, \textcolor{red}{and the semantics of relational invocation reduces to the application of corresponding
...
This condition guarantees that our semantics is complete in the sense that it does not introduce artificial restrictions for the relation it defines. \textcolor{red}{It
...
\textcolor{blue}{It is interesting that in \textsc{Coq} implementation we do not need to refer to Tarski-Knaster theorem explicitly since
