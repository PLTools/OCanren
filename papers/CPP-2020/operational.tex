...
A derivation sequence for a certain state determines a \emph{trace}~--- a finite or infinite sequence of answers.

\begin{comment}
{ \color{lightgray} We may define a set of finite or infinite
