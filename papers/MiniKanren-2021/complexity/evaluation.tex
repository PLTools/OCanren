...
\begin{figure}[t]
      \[ \begin{tabular}{|c|c|c|c|c|}
           ...
           \lstinline|plus$^o$ $\overline{n}$ $y^?$ $\overline{k}$| & $\min(n, k)$ & $\min(n, k)$ & $\min(n, k) \cdot \max(n, k)$ & $\max(n - m, 0)$  \\
           \lstinline|plus$^o$ $x^?$ $y^?$ $\overline{k}$| & $k$ & $k$ & $k^2$ & $k^2$  \\
           \lstinline|mult$^o$ $\overline{n}$ $\overline{m}$ $r^?$| & $n^2 m$ & $n m$ & $n m^2 + n^2 m$ & $n m$  \\
           \lstinline|mult$^o$ $x^?$ $\overline{m + 1}$ $\overline{k}$| & $k$ & $k$ & $k^2$ & $\frac{k}{m}$  \\
...
\begin{figure}[t]
    \[
      \begin{tabular}{|c|c|c|}
           ...
           \lstinline|plus$^o$ $\overline{n}$ $y^?$ $\overline{k}$| & $\min(n, k) \cdot \log \min(n, k)$ & $\min(n, k) \cdot \max(n, k) \cdot \log \min(n, k)$ \\
           ...
           \lstinline|mult$^o$ $x^?$ $\overline{m + 1}$ $\overline{k}$| & $k \log k$ & $k^2 \log k$ \\
