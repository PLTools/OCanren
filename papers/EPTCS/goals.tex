...
In this setting, the run primitive is represented by the follwing function:
...
variables their disequality constraints have to be reified additionaly (e.g. represented as a list of
