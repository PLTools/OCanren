...
% Формально оно так, но если мы перестанем разрешать вставлять ложики везде, 
% а будем вставлять только в некоторых местах, то полиморфная унификация будет делать лишнии проверки, так как 
% обходит всё
