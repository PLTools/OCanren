...
\noindent where ``\lstinline{term}'' stands for , representing typed terms, ``\lstinline{subst}'' stands for the type of
...
and it is performed in the context of existing substitution (hence ``\lstinline{subst}'' in the third argument) and can be
...
the low-level, unsafe interface \lstinline{Obj}. Note also, the correctness our of implementation is based on
