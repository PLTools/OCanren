...
\begin{center}
{\bf Unification is virtually the main thing to implement}
\end{center}
\end{frame}
...
\begin{itemize}
\item Types are erased in substitution
\item Have to be reconstructed properly during refinement
\item States must not escape the scope
\end{itemize}
\end{frame}
