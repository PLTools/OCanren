...
\emph{polymorphic unification}, which can be used to unify structures of almost 
...
The function \lstinline{unify} is not directly accessible at the user level; it used
