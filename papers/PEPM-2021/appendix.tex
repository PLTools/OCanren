...
\begin{proof}
  ...
  \[
  h\,(\inbr{\theta\cdot[b\to\beta_i],\,\phi a \psi})\le h\,( \inbr{\theta,\,\phi b \psi})
  \]
  ...
  If we change $b$ to $\beta_i$ in the state $\inbr{\theta,\,\phi b \psi}$ we won't be able to perform the unfolding of $b$ anymore; however, the state in which this
