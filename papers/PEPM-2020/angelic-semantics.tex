...
If current state is a leaf with a non-empty list of relation applications, then we non-deterministacally choose one for a one-step unfolding (rule \rulen{ConjUnfold}). After the
