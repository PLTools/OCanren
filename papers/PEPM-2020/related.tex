...
In~\cite{Naish1985AutomatingCF} a discipline of delaying certain predicates in current goal to improve the performance/convergence was addressed. The approach proposed makes use of two
