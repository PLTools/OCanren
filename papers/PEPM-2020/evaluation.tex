...
In this section we evaluate the fair semantics based on well quasi-ordering predicate suggested in the previous section. We also evalute
similar semantics based on three differet predicates. All these semantics were implemented in \textsc{Haskell} in forms of interpreters.
