...
We are currently working on proving the independence of this semantics from the order of the 
uncts in the case when all relations are relations with structural recursion.
