...
In the pessimistic case the evaluation time of the directrf conjunction rapidly increases, the evaluation time of the naive fair conjunction also increases, but not so much.
The fair conjunction based on structural recursion demonstrates the similar efficiency as in the optimistic case.
...
The results are presented in more details on Fig.~\ref{fair:evaluation-table}. We can conclude that \lstinline{sort$^o$} runtime in the pessimistic case increases
