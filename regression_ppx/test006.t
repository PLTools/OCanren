    ...
    include struct
      ...
      include struct
        ...
        let gcata_t
          ...
          =
          match subj with
          | Symb _x__001_ -> tr#c_Symb inh subj _x__001_
          | Seq _x__002_ -> tr#c_Seq inh subj _x__002_
        ;;
        ...
        class ['s, 's_2, 'xs, 'xs_2, 'extra_t, 'syn_t] gmap_t_t fs fxs =
          ...
          fun _fself_t ->
            object
              inherit
                [unit, 's, 's_2, unit, 'xs, 'xs_2, unit, 'extra_t, ('s_2, 'xs_2) t] t_t
      ...
      type injected =
        (GT.string OCanren.ilogic, injected Std.List.injected) t OCanren.ilogic
      ...
      let (reify :
            (_, (GT.string OCanren.logic, logic Std.List.logic) t OCanren.logic) Reifier.t)
        =
        let open Env.Monad in
        let open Env.Monad.Syntax in
        Reifier.fix (fun self ->
    ...
    include struct
      ...
      include struct
        ...
        let gcata_t
          ...
          | Val _x__010_ -> tr#c_Val inh subj _x__010_
        ;;
        ...
        let t =
          ...
          ; GT.plugins =
              object
                method gmap fs ft fxs subj =
                  gmap_t (GT.lift fs) (GT.lift ft) (GT.lift fxs) () subj
              end
          }
        ;;
      ...
      let closure _x__006_ _x__007_ _x__008_ =
        OCanren.inji (Closure (_x__006_, _x__007_, _x__008_))
      ;;
