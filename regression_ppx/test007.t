  ...
  Inhabitants of scheme terms:
   ...
   2: Seq ([Symb (_.6)])
   3: Seq ([Seq ([])])
   4: Seq ([Symb (_.6); Symb (_.13)])
   5: Seq ([Symb (_.6); Seq ([])])
   6: Seq ([Seq ([]); Symb (_.23)])
   7: Seq ([Seq ([Symb (_.16)])])
   8: Seq ([Symb (_.6); Symb (_.13); Symb (_.26)])
   9: Seq ([Seq ([]); Seq ([])])
  Inhabitants of scheme interpreter results:
   ...
   3: Val (Seq ([Symb (_.12)]))
   4: Closure ([], Seq ([]))
   5: Closure ([(_.15, Symb (_.21))], Symb (_.5))
   6: Val (Seq ([Seq ([])]))
   7: Val (Seq ([Symb (_.12); Symb (_.29)]))
   8: Closure ([(_.15, Seq ([]))], Symb (_.5))
   9: Closure ([(_.32, Symb (_.45))], Seq ([]))
