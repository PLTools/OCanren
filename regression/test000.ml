...
let int_opt_reifier = Option.reify Reify.int
...
let _ = Option.(
    ...
    runR Reify.int show_int     show_intl   1 q qh (REPR(fun q -> some q === some !!5 ));
...
let runResult n = runR (Result.reify Reify.int int_opt_reifier) show1 show1logic n
