...
let () =
  run_exn show_bool        1    q  qh (REPR (fun q     -> Bool.noto Bool.truo  q                       ));
  run_exn show_bool        1    q  qh (REPR (fun q     -> Bool.noto Bool.falso q                       ));
  run_exn show_bool        1    q  qh (REPR (fun q     -> Bool.noto q          Bool.truo               ));
  run_exn show_bool        1    q  qh (REPR (fun q     -> Bool.oro   Bool.falso Bool.falso q            ));
  run_exn show_bool        1    q  qh (REPR (fun q     -> Bool.oro   Bool.falso Bool.truo  q            ));
  run_exn show_bool        1    q  qh (REPR (fun q     -> Bool.oro   Bool.truo  Bool.falso q            ));
  run_exn show_bool        1    q  qh (REPR (fun q     -> Bool.oro   Bool.truo  Bool.truo  q            ));
  run_exn show_bool        1    q  qh (REPR (fun q     -> Bool.ando  Bool.falso Bool.falso q            ));
  run_exn show_bool        1    q  qh (REPR (fun q     -> Bool.ando  Bool.falso Bool.truo  q            ));
  run_exn show_bool        1    q  qh (REPR (fun q     -> Bool.ando  Bool.truo  Bool.falso q            ));
  run_exn show_bool        1    q  qh (REPR (fun q     -> Bool.ando  Bool.truo  Bool.truo  q            ));
...
let () =
  ...
  run_exn show_nat_List    1    q   qh (REPR (fun q     -> List.lengtho q ?$0                                 ));
  ...
  run_exn show_bool        1    q   qh (REPR (fun q     -> List.allo (Bool.truo % (q %< Bool.truo)) Bool.truo     ));
  run_exn show_bool      (-1) qrs qrsh (REPR (fun q r s -> List.allo (Bool.truo % (q %< r)) s                     ))

let _ =
  run_exn show_nat_List    1    q  qh (REPR (fun q      -> List.mapo (Nat.addo ?$1) (nats [0;1;2]) q              ));
  run_exn show_nat_List    1    q  qh (REPR (fun q      -> List.mapo (Nat.addo ?$2) q (nats [4;3;2])              ));
  ...
  run_exn show_nat_List    1    q  qh (REPR (fun q      -> List.mapo (===) (nats [1;2;3]) q                       ));
  run_exn show_nat         1    q  qh (REPR (fun q      -> List.mapo (===) (nats [1;2;3]) (?$1 % (?$2 %< q))      ));
  run_exn show_bool_List   1    q  qh (REPR (fun q      -> List.mapo Bool.noto (bools [true;false;true;]) q       ));
  run_exn show_bool_List   1    q  qh (REPR (fun q      -> List.mapo Bool.noto (bools []) q                       ));

  run_exn show_nat_List  (-1)   q  qh (REPR (fun q    -> List.filtero (eqo ?$2) (nats [0;1;2;3]) q              ));
